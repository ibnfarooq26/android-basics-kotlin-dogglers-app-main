...
public final class VerticalHorizontalListItemBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView textViewHobbies;

  @NonNull
  public final TextView textViewName;

  private VerticalHorizontalListItemBinding(@NonNull MaterialCardView rootView,
      @NonNull ImageView imageView, @NonNull TextView textViewAge,
      @NonNull TextView textViewHobbies, @NonNull TextView textViewName) {
    this.rootView = rootView;
    this.imageView = imageView;
    this.textViewAge = textViewAge;
    this.textViewHobbies = textViewHobbies;
  ...
  public static VerticalHorizontalListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView textViewAge = rootView.findViewById(id);
      if (textViewAge == null) {
        break missingId;
      }

      id = R.id.text_view_hobbies;
      TextView textViewHobbies = rootView.findViewById(id);
      if (textViewHobbies == null) {
        break missingId;
      }
      ...
      return new VerticalHorizontalListItemBinding((MaterialCardView) rootView, imageView,
          textViewAge, textViewHobbies, textViewName);
    }
